      ...
      <div ref={ref} style={{ 
        ...
        >
          <div style={{ 
            ...
            <div style={{ 
              ...
              {language === 'ar' ? '╪º┘ä╪Ñ╪╣╪»╪º╪» ╪º┘ä╪░┘â┘è' : 'SMART SETUP'}
            </div>
          </div>
        </div>
        ...
        <div style={cardStyle}>
          <div style={labelStyle}>
            ...
            <span style={{ fontSize: '14px', fontWeight: '950' }}>{language === 'ar' ? '╪º┘ä┘ä╪║╪⌐' : 'LANGUAGE'}</span>
          </div>
        ...
        <div style={cardStyle}>
          <div style={labelStyle}>
            <div style={{ width: '4px', height: '4px', borderRadius: '50%', background: '#ff3d00', boxShadow: '0 0 8px #ff3d00' }} />
            <span style={{ fontSize: '13px', fontWeight: '950' }}>{language === 'ar' ? '╪º┘ä╪º╪│┘à ╪º┘ä╪┤╪«╪╡┘è' : 'PROFILE IDENTITY'}</span>
          </div>
        ...
        <div style={{ 
          ...
          >
            ...
            <div style={{ 
              ...
              {language === 'ar' ? '╪º╪╢╪║╪╖ ┘ä┘ä╪¿╪»╪í' : 'TAP TO BEGIN'}
            </div>
          </div>
        </div>
