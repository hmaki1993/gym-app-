    ...
    <>
        ...
        >
          ...
          >
            ...
            <h2 className="heading-font logo-underline" style={{ color: '#fff', fontSize: '26px', marginBottom: '16px' }}>
              {lang === 'ar' ? '╪¬╪╡┘ü┘è╪▒ ╪º┘ä┘à╪╡┘å╪╣╪ƒ' : 'FACTORY RESET?'}
            </h2>
            
            <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '15px', lineHeight: '1.6', marginBottom: '32px' }}>
              {lang === 'ar' ? 'ΓÜá∩╕Å ╪│┘è╪¬┘à ┘à╪│╪¡ ┘â┘ä ╪¿┘è╪º┘å╪º╪¬┘â ┘å┘ç╪º╪ª┘è╪º┘ï!' : 'ΓÜá∩╕Å This will permanently delete all your data!'}
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              ...
              >
                {lang === 'ar' ? '╪¬╪ú┘â┘è╪» ╪º┘ä┘à╪│╪¡' : 'CONFIRM RESET'}
              </button>
      ...
      <div style={{ ...cardStyle, gap: '15px' }}>
         ...
         <div style={{ marginTop: '100px', display: 'flex', justifyContent: 'center' }}>
            ...
            >
              {lang === 'ar' ? '╪¬╪╡┘ü┘è╪▒ ╪º┘ä┘à╪╡┘å╪╣' : 'FACTORY RESET'}
            </button>
         </div>
      </div>
